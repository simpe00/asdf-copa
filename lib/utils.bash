...
# TODO: Ensure this is the correct GitHub homepage where releases can be downloaded for copa.
GH_REPO="https://github.com/project-copacetic/copacetic"
TOOL_NAME="copa"
TOOL_TEST="copa --version"
...
list_all_versions() {
	...
	# Change this function if copa has other means of determining installable versions.
	list_github_tags
}
...
download_release() {
	...
	curl "${curl_opts[@]}" -o "~/Downloads" -C - "$url" || fail "Could not download $url"
}
